...
class TestCard(unittest.TestCase):
    ...
    def test_q5(self):
        ...
        d1 = hw5_cards.Deck()
        c1 = d1.deal_card()
        x = hw5_cards.Card(3,13)
        self.assertEqual(c1.__str__(), x.__str__())
        X = c1
        Y = x
        return X, Y
    ...
    def test_q6(self):
        ...
        d1_len = len(d1.cards)
        d1.deal_card()
        d1_len_2 = len(d1.cards)
        self.assertEqual(d1_len-1, d1_len_2 )
        X = d1_len-1
        Y = d1_len_2 
        return X, Y
    ...
    def test_q7(self):
        ...
        d1.deal_card()
        d1_len = len(d1.cards)
        d1.replace_card(hw5_cards.Card(3,13))
        d1_len_2 = len(d1.cards)
        self.assertEqual(d1_len + 1, d1_len_2)
        X = d1_len + 1
        Y = d1_len_2
    ...
    def test_q8(self):
        ...
        d1.replace_card(hw5_cards.Card(3,13))
        d1_len_2 = len(d1.cards)
        self.assertEqual(d1_len, d1_len_2)
        X = d1_len
        Y = d1_len_2
        return X, Y  
